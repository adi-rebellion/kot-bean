<x-guest-layout title="Set new password">
    <div class="mb-8">
        ...
        <h2 class="landing-display mt-2 text-2xl font-semibold tracking-tight text-zinc-950">Set a new password</h2>
        <p class="mt-2 text-sm text-zinc-500">Choose a strong password for your KotBean account.</p>
    </div>
